...
const products = [
    {
        ...
        description: [
            "Мельница находится в идеальном состоянии и готова к эксплуатации. Если позиция вам подходит, предлагайте адекватную цену, пишите, договоримся.",
            "Продаётся современный мельничный комплекс для сухого измельчения какавеллы и других пищевых или непищевых материалов до фракции микронного размера.",
            "В составе комплекса две ступени: молотковая мельница высокой производительности для предварительного или основного помола и мельница сверхтонкого помола для финального доведения продукта до нужной фракции. Молотковая мельница продаётся только в составе комплекса.",
            "Ключевое преимущество комплекса — высокая тонкость помола. По какавелле можно получить фракцию до 1 микрона, а производительность тонкого помола до 20 мкм составляет до 200 кг/час.",
            "Комплекс можно настроить под широкий спектр сухих сыпучих материалов: специи, минеральные добавки, продукты переработки и другие похожие задачи. Двухступенчатая схема даёт стабильный результат и нормальную энергоэффективность.",
            "Это решение подойдёт для производства суперфайного какао-порошка из какавеллы, переработки вторичного сырья в пищевой промышленности, выпуска функциональных пищевых ингредиентов, а также для исследовательских центров и лабораторий.",
            "Запросы, по которым обычно ищут такую позицию: измельчение какавеллы, сверхтонкий помол, молотковая мельница, мельница тонкого помола, производство какао-порошка, переработка отходов какао, изготовление пищевых порошков, диспергирование, микронизация и сухое измельчение. Также возможно измельчение специй и минералов.",
            "В фотографиях размещена таблица №1 с гранулометрическим составом помола какаовеллы. Производительность по какаовелле составила 200 кг/час.",
            "В фотографиях также размещены таблица №2 с порошком оксида цинка до помола и таблица №3 после помола. На таблице №3 видно, что помол получается однородным, D98 — 20 мкм.",
            "Комплекс готов к работе. Рассмотрим все варианты сотрудничества."
        ],
        specs: [
            ["Цена", "5 000 000 ₽"],
    ...
    },
    {
        ...
        name: "Смеситель с водяной рубашкой для специй, какао и комбикорма",
        price: "450 000 ₽",
        shortSummary: "Универсальный роторно-лопастной смеситель с водяной рубашкой для сухих и жиросодержащих смесей, с возможностью ввода жидких компонентов.",
        ...
        description: [
            "Универсальный высокоэффективный смеситель для создания однородных сухих и жиросодержащих смесей. Это рабочее решение для производств, где важны качество смешивания, надёжность и простое обслуживание.",
            "Оборудование подходит для приготовления многокомпонентных смесей в пищевой промышленности, сельском хозяйстве, фармацевтике и химии. На нём можно работать со специями, приправами, детскими смесями, сухими завтраками, порошками для напитков, смесями для выпечки, какаовеллой, комбикормами, премиксами, порошковыми фармпрепаратами и химическими составами.",
            "Смеситель обеспечивает однородность смеси до 98% по лабораторным анализам. Есть функция впрыска жидких компонентов в процессе смешивания, поэтому можно добавлять ароматизаторы, масла и другие жидкие добавки прямо во время работы.",
            "Водяная рубашка позволяет работать с твёрдыми жирами, включая какао-масло, кокосовое и пальмовое масло. Жиры предварительно растапливаются в жиротопке, которая входит в комплект при необходимости.",
            "По сравнению с аналогами смеситель проще в работе, не требует специальных навыков, служит дольше импортных вариантов, занимает меньше места и при этом сохраняет хорошую мощность привода и производительность.",
            "Оборудование удобно чистить между сменами продукта, оно работает тихо и может использоваться как с жиротопкой, так и автономно для стандартных сухих смесей.",
            "Такой смеситель подойдёт для пищевых комбинатов, фасовочных цехов, производителей специй, комбикормовых заводов, небольших производств food-сектора и фармацевтических площадок.",
            "В комплекте смеситель, жиротопка по необходимости и документация. Возможна поставка дополнительного оборудования."
        ],
        specs: [
            ["Цена", "450 000 ₽"],
            ["Вид оборудования", "Промышленное"],
            ...
            ["Водяная рубашка", "Есть"],
            ["Впрыск жидких компонентов", "Есть"],
        ...
        video: [
            {
                type: "video",
                src: "assets/products/работа сместителя.mp4",
                title: "Видео работы смесителя"
            },
            {
                type: "video",
                src: "assets/products/mixer-video.mp4",
                title: "Видео жиротопки из комплекта"
            }
        ]
    },
    {
        ...
        price: "250 000 ₽",
        shortSummary: "Новый промышленный электродвигатель 26,4 кВт с защитой IP55 и оборотами 3540 об/мин для стабильной производственной нагрузки.",
        ...
        description: [
            "Новый электродвигатель под производственную нагрузку, где важны стабильные обороты, нормальный запас по защите и понятные паспортные характеристики.",
    ...
    {
        slug: "kalibr-jackhammer",
        name: "Отбойный молоток Калибр",
        price: "15 000 ₽",
        shortSummary: "Отбойный молоток Калибр 1,7 кВт и 65 Дж для тяжёлых демонтажных работ: вскрытие дорожного полотна, разрушение фундамента и бетонных опор.",
        preview: "assets/products/calibr-hammer-1.webp",
        images: [
            "assets/products/calibr-hammer-1.webp",
            "assets/products/calibr-hammer-2.webp",
            "assets/products/calibr-hammer-3.webp",
            "assets/products/calibr-hammer-4.webp"
        ],
        description: [
            "Отбойный молоток Калибр подходит для тяжёлых работ, где нужен уверенный удар и нормальный запас по мощности. Подойдёт для вскрытия дорожного полотна, разрушения фундамента, бетонных опор и другого жёсткого демонтажа.",
            "Мощность инструмента составляет 1,7 кВт, энергия удара — 65 Дж. За счёт этого молоток рассчитан именно на тяжёлую нагрузку, а не на мелкие бытовые задачи.",
            "Металлический корпус хорошо защищает внутренние элементы от повреждений. Основная рукоятка с резиновой накладкой удобна в работе и не даёт руке соскальзывать.",
            "Дополнительная D-образная рукоятка вращается вокруг своей оси, поэтому инструмент проще контролировать в работе и удобнее подстраивать под положение оператора.",
            "Патрон — 30 мм шестигранник. У молотка эффективный ударный механизм, высокая производительность и большая энергия удара. Торг возможен на месте."
        ],
        specs: [
            ["Цена", "15 000 ₽"],
            ["Состояние", "Б/у"],
            ["Доступность", "В наличии"],
            ["Бренд", "Калибр"],
            ["Вид оборудования", "Строительный инструмент"],
            ["Тип инструмента", "Отбойный молоток"],
            ["Назначение", "Для вскрытия дорожного полотна, разрушения фундамента, бетона и тяжёлых демонтажных работ"],
            ["Мощность", "1,7 кВт"],
            ["Энергия удара", "65 Дж"],
            ["Патрон", "30 мм шестигранник"],
            ["Корпус", "Металлический"],
            ["Дополнительная рукоятка", "D-образная, поворотная"],
            ["Торг", "На месте"]
        ],
        video: null
    },
    {
        slug: "optimum-drill-press",
        name: "Настольный сверлильный станок OPTIMUM",
        price: "15 000 ₽",
        shortSummary: "Настольный сверлильный станок для сверления, расточки, зенкеровки и нарезания внутренней резьбы по металлу.",
        preview: "assets/products/drill-press-1.webp",
        images: [
            "assets/products/drill-press-1.webp",
            "assets/products/drill-press-2.webp",
            "assets/products/drill-press-3.webp",
            "assets/products/drill-press-4.webp"
        ],
        description: [
            "Настольный сверлильный станок в наличии. Подходит для металлообработки, когда нужна аккуратная работа по сверлению и расточке без лишней громоздкости по месту.",
            "В станке установлены высокоточные опорные подшипники шпинделя, а быстросменный патрон ROHM идёт в комплекте. Качественный зубчатый приводной ремень исключает проскальзывание и потери мощности.",
            "Эргономичная рукоятка подачи пиноли удобна в работе, а шлифованные алюминиевые шкивы дают более плавное вращение шпинделя. Есть регулируемый упор глубины сверления.",
            "Стол выполнен с точной геометрией поверхности и зубчатым механизмом перемещения. Его можно вращать на 360 градусов вокруг своей оси и наклонять на ±45 градусов в вертикальной плоскости.",
            "Основание массивное, с шлифованной поверхностью и двумя Т-образными пазами. Электродвигатель надёжный, с алюминиевым корпусом и принудительным охлаждением.",
            "Станок можно использовать для рассверливания, развертывания, зенкеровки, вырезания дисков из листовых материалов и нарезания внутренней резьбы."
        ],
        specs: [
            ["Цена", "15 000 ₽"],
            ["Вид оборудования", "Промышленное"],
            ...
            ["Метод обработки", "Сверление и расточка"],
            ["Страна производства", "Россия"],
            ["Состояние", "Б/у"],
            ["Доступность", "В наличии"],
            ...
            ["Размер стола", "200 x 200 / 12 мм"],
            ["Скорость вращения", "500 - 2520 об/мин"],
            ["Количество скоростей", "5"],
            ["Максимальный d-сверления", "16 мм"],
            ["Перемещение пиноли", "65 мм"],
            ["Конец шпинделя", "Морзе 2"],
            ["Вылет оси шпинделя", "152 мм"],
...
const getVideoConfigs = (video) => {
    const source = Array.isArray(video) ? video : [video];
    return source
        .map((item) => getVideoConfig(item))
        .filter(Boolean);
};
...
const detailMarkup = (product) => {
    ...
    const videos = getVideoConfigs(product.video);
...
const initMediaModal = () => {
    ...
    document.querySelectorAll("[data-open-video]").forEach((button) => {
        button.addEventListener("click", () => {
            ...
            const videos = getVideoConfigs(product?.video);
            const requestedIndex = Number(button.dataset.videoIndex ?? 0);
            const video = videos[requestedIndex] ?? videos[0];
            if (!video) return;
